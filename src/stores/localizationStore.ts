...
type NodeTranslationHeaders = Record<string, unknown>;
...
export const useLocalizationStore = defineStore('localization', {
  ...
  actions: {
    ...
    translator:
      (state: any, field: string, toString: string | undefined) =>
    ...
    addHeaders(headers: NodeTranslationHeaders, language: string) {
