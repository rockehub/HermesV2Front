<template>
  ...
  >
    <div class="text-base font-semibold text-slate-800 dark:text-navy-50">
      {{ configuration?.title || 'Perguntas frequentes' }}
    </div>
    <div class="mt-2 text-sm text-slate-500 dark:text-navy-300">
      Accordion preview with common customer questions.
    </div>
  </div>
</template>
