    ...
    <nav class="header print:hidden">
      <div class="header-container relative flex w-full bg-white dark:bg-navy-700 print:hidden">
        ...
        <div class="flex w-full items-center justify-center">
          ...
          <div class="h-7 w-7" v-if="$breakpoints.smAndDown">
            <button
              class="menu-toggle ml-0.5 flex h-7 w-7 flex-col justify-center space-y-1.5 text-primary outline-none focus:outline-none dark:text-accent-light/80"
              :class="globalState.isSidebarExpanded && 'active'"
          ...
          <div class="-mr-1.5 flex items-center space-x-2">
            ...
            <button
              @click="globalState.toggleSearchbar()"
            ...
            >
              <transition
                enter-active-class="transition-transform duration-200 ease-out absolute origin-top"
                enter-class="scale-75"
                enter-to-class="scale-100 static"
              >
                <svg
                  v-show="globalState.isDarkMode"
            ...
            <button
              @click="globalState.toggleMonochrome()"
              class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
            >
              <i
            ...
            <button
              @click="globalState.toggleRightSidebar()"
              class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
