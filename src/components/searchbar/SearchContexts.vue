<template>
  ...
  >
    ...
    >
      <span>{{ $t('search.context.'+searchStore.getSearchContexts) ?? $t('search.searchContexts') }}</span>
      <svg
    ...
    <template
      ...
      >
        <ul>
          <li   v-for="context in loadedContexts"
                     :key="context.label">
                      <a @click="selectContext(context.value)"
                         href="#"
          ...
          export default defineComponent({
            ...
            methods: {
              selectContext(context: string) {
                this.searchStore.setSearchContexts(context)
                this.closeDropDown()
              },
              toggleDropdown() {
